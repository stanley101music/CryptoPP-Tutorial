...
#define KEY_SIZE DES_EDE3::DEFAULT_KEYLENGTH
#define BLOCK_SIZE DES_EDE3::BLOCKSIZE
...
int main(int argc, char* argv[])
{
	...
	CBC_Mode<DES_EDE3>::Encryption encrypt(key, key.size(), iv);
	...
	// Decryption
	CBC_Mode<DES_EDE3>::Decryption decrypt(key, key.size(), iv);
